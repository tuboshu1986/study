...
public class ProductOther extends BaseModel {
    ...
    @Where(clause = "(isDel is null or isDel = 0) and object_type='" + ProductFile.ProductFileType.PRODUCT_OTHER_EXPLAIN + "'")
    private List<ProductFile> explain;
    /**
     * 包装说明-历史记录
     */
    @OneToMany(fetch = FetchType.LAZY, mappedBy = "objectId")
    @Where(clause = "is_del = 1 and object_type='" + ProductFile.ProductFileType.PRODUCT_OTHER_EXPLAIN + "'")
